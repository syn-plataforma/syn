...
from syn.helpers.argparser import dataset_parser, assignation_task_parser, similarity_task_parser
...
def get_input_params():
    parser = argparse.ArgumentParser(
        parents=[dataset_parser, assignation_task_parser, similarity_task_parser],
...
def load_dataset(
    ...
    return load_dataset_from_mongodb(task=task, database_name=corpus, collection_name=name, query_limit=query_limit)
...
def encode_dataset_structured_data(
    ...
    structured_data_column_name = os.environ["COMPOSITE_ID_FIELDS"].split(",")
    ...
    if task != 'custom_assignation':
        ...
        updated_structured_data_column_name = structured_data_column_name
