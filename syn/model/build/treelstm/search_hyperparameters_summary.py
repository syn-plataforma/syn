...
def get_input_params():
    ...
    parser.add_argument('--fields',
                        default='learning_rate_param,learning_rate_embed,max_epochs,embeddings_model,embeddings_pretrained,sentence_hidden_dim,attention,attention_dim,structured_data_hidden_dim',
                        type=str, help='Number of retrieved models.')
