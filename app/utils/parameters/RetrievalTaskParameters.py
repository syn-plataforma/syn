...
from app.utils.parameters.RetrievalStepTaskParameters import RetrievalStepTaskParameters


class RetrievalTaskParameters(BaseTaskParameters):
    ...
    def __init__(
        ...
        if steps is None:
            steps = [
                ...
                RetrievalStepTaskParameters(),
                RetrievalStepTaskParameters(name='all_steps', endpoint='all_retrieval/')
            ]
