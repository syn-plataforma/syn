...
from app.utils.parameters.DuplicatesStepQueryStringParameters import DuplicatesStepQueryStringParameters


class DuplicatesStepTaskParameters(BaseStepTaskParameters):
    ...
    def __init__(
            ...
            endpoint='duplicates/',
            query_string='',
            query_string_parameters=DuplicatesStepQueryStringParameters()
    ):
