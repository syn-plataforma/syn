...
class OpenOfficeDuplicatesMongoCollection(MongoCollection):
    def __init__(
            self,
            ...
            coll_name=os.environ.get('MONGO_DUPLICATES_COLLECTION', DevelopmentConfig.MONGO_DUPLICATES_COLLECTION)
    ):
